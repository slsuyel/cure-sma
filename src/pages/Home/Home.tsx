        ...
        <main>
              ...
              <div className="lg:absolute bottom-6 xl:bottom-0 ">
                <div>
                  ...
                  <div className="flex items-center justify-center -mt-4">
                    <a href="donate-cure-sma-bd.html">
                ...
                <div>
                  ...
                  <div className="rounded-tr-[100px] pr-5 lg:pr-20 pl-6 lg:pl-[450px] xl:pl-[650px] banner-bgw">
                    ...
                    <p className="font-normal lg:leading-8 xl:leading-8 text-justify text-base lg:text-lg xl:text-xl">
                      ...
                      2023, and have continuously been expanding our network
                      since then to represent SMA families and individuals
                      across the country. We support SMA families through
                      accurate counselling, rich resource pool, patient advocacy
                      and various direct family support services. We are
                      extensively working to empower SMA patients and enabling
                      them to access existing services.
                      <a
                        className="ps-3 text-red-500 hover:text-pColor"
                        href="/"
                      >
                        Read More...
                      </a>
          ...
          <div className="mb-20">
            ...
            <div className="w-full h-full flex justify-between px-8 items-center">
              ...
              <a
                href="https://maps.app.goo.gl/nvFrX2B7xdiTj7cw8"
                target="_blank"
              >
                <img
                  className="shadow-none hover:shadow-xl"
              ...
              <div className="lg:flex justify-between items-center text-center">
                <div className="w-full lg:w-1/2 mr-16">
                  ...
                  <p className="text-sm leading-normal lg:text-lg xl:leading-8 text-justify">
                    ...
                    neuromuscular condition, affecting approximately about 1 in
                    10,000 people. Muscle wasting and gradual mobility loss are
                    symptoms of spinal muscular atrophy. It is brought on by
                    degeneration of the nerve cells (motor neurons) that link
                    the brain, spinal cord, and muscles of the body. The muscles
                    used for movements like crawling, walking, sitting up,
                    moving the head, and even swallowing gradually weaken and
                    shrink (atrophied) as the connection between the nerves and
                    muscles is interrupted.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <div className="mb-8">
                    <p className="text-xl lg:text-2xl text-center leading-8">
                      ...
                      perseverance, and hope. These individuals bravely navigate
                      the challenges of Spinal Muscular Atrophy (SMA), a genetic
                      disorder affecting the motor neurons in the spinal cord,
                      leading to muscle weakness and atrophy. Despite the
                      limitations imposed by SMA, patients demonstrate
                      remarkable strength in their daily lives, often overcoming
                      obstacles with unwavering determination. Their stories
                      inspire awareness, advocacy, and progress in SMA research
                      and treatment, offering a glimpse into the human spirit's
                      capacity to thrive amidst adversity.
                    </p>
                  </div>
                </div>
                <div className="flex flex-col sm:flex-row sm:justify-between gap-6 sm:gap-10">
                  ...
                  >
                    ...
                    <div className="px-8 text-center my-8">
                      ...
                      >
                        SMA patient stories are powerful narratives of
                        resilience, perseverance, and hope. These individuals{' '}

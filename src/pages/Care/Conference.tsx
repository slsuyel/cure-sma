      ...
      <main>
        ...
        <div className="flex justify-between px-8 mx:px-16 items-center bg-[#000009] border-b-[12px] lg:border-b-[25px] border-[#08A268] drop-shadow-lg">
          <div className="text-white font-semibold px-4 lg:pr-16">
            <h1 className="text-xl md:text-4xl lg:text-7xl drop-shadow-lg">
              SMA
            </h1>
            <h1 className="text-xl md:text-4xl lg:text-5xl drop-shadow-lg">
              Conferences / Meetings
            </h1>
          </div>
          <div>
            <img
              src="https://forhadhub.github.io/CSMA-Web/src/images/conference-banner-image.jpg"
        ...
        <div className="flex flex-col items-center justify-center bg-[#08A268]/20 p-6">
          <div className="relative w-80">
            <label
              ...
              className="block text-xl font-medium text-[#08A268] mb-2 text-center"
            >
              Select Activity
            </label>
            <select
              id="photo_category"
              name="photo_category"
              className="block w-full bg-green-100/50 h-10 rounded-md shadow-sm text-lg font-semibold text-[#08A268] max-h-32 overflow-y-auto"
            >
              <option disabled selected>
                Select
              </option>
              <option value="All Awareness">All Meetings</option>
              <option value="Rare Disease Day-2024">
        ...
        {/* category name */}
        <h1 className="pt-10 text-2xl text-[#08A268] font-bold text-center">
          Category Name: <span>Conference-2024</span>
        </h1>
        {/* meeting videos */}
            ...
            <div className="flex flex-col lg:flex-row bg-white/75 rounded-lg drop-shadow-lg items-center lg:pr-2 h-full transform transition-transform duration-1000 hover:bg-green-100/50">
              <div className="w-full lg:w-3/5 rounded-lg overflow-hidden shadow-lg transform transition-transform duration-1000 hover:scale-105">
                <iframe
                  width="100%"
                  height={315}
                  src="https://www.youtube.com/embed/wmKtQ_aRdqg?si=wshrAdfFZmYv3h5_"
              ...
              <div className="text-center lg:text-left px-4 w-full lg:w-2/5">
                {/* Title */}
                <h2 className="text-lg lg:text-2xl font-semibold text-green-600">
                  2024 HCU Conference Keynote
                </h2>
                <div className="py-2">
            ...
            <div className="flex flex-col lg:flex-row bg-white/75 rounded-lg drop-shadow-lg items-center lg:pr-2 h-full transform transition-transform duration-1000 hover:bg-green-100/50">
              <div className="w-full lg:w-3/5 rounded-lg overflow-hidden shadow-lg transform transition-transform duration-1000 hover:scale-105">
                <iframe
                  width="100%"
                  height={315}
                  src="https://www.youtube.com/embed/JQC4nW_oQHU?si=ZIgDlk_ydxOZpl0O"
                  title="YouTube video player"
                  frameBorder={0}
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                  referrerPolicy="strict-origin-when-cross-origin"
              ...
              <div className="text-center lg:text-left px-4 w-full lg:w-2/5">
                ...
                <h2 className="text-lg lg:text-2xl font-semibold text-green-600">
                  {' '}
                  Challenge of Rare Disease in the Family
                </h2>
                <div className="py-2">
                  <p className="font-semibold">Meeting Date:</p>
                  <p>24 July 2024</p>
